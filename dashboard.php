...
<div class='container'>
	<div class="row">
		<div class="main panel col-md-12 text-center">
			...
			<div class="Hero_triangle__t_hGV">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 698 844" fill="none">
					<rect x="622.165" y="-485.604" width="1000.24" height="879.874" transform="rotate(45 622.165 -485.604)" fill="#F3F3F5"></rect>
				</svg>
			</div>
		</div>
		</div>
		...
		<div class="content-wrapper">
			<div class="row align-items-center no-gutters">
				...
				<div class="col-md-8 col-12">
					<h4 class="heading">Loyalty and Reviews</h4>
